        ...
        <div className="p-6">
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              rows={3}
              disabled={isLoading}
              className="w-full rounded-lg border border-gray-600 bg-gray-700 px-3 py-2 text-sm text-gray-100 placeholder:text-gray-500 outline-none transition-colors focus:border-brand-hover"
            />
          </div>

    ...
    <Card>
      ...
      {isLoading ? (
        <div className="flex items-center justify-center py-8">
          <div className="h-6 w-6 animate-spin rounded-full border-2 border-gray-700 border-t-brand-hover"></div>
        </div>
          ...
          {auditLog.slice(0, 5).map((event, idx) => (
            ...
            >
              <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-gray-700">
                <FiActivity className="text-sm text-gray-400" />
              </div>
        ...
        <div className="flex flex-col items-center justify-center py-8">
          <FiActivity className="text-2xl text-gray-500 mb-2" />

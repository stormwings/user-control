...
export const UserProfileFields = ({ values, onChange, mode = 'create', errors }) => {
  ...
  const inputClass = "mt-2 rounded-lg border border-gray-600 bg-gray-700 px-3 py-3 text-gray-100 placeholder:text-gray-500 outline-none transition-colors focus:border-brand-hover focus:bg-gray-600 focus:ring-4 focus:ring-[rgba(64,153,175,0.15)]";
  const labelClass = "text-sm font-semibold text-brand-hover";
